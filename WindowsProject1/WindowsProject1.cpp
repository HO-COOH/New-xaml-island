...
winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource g_source{nullptr};
winrt::RuntimeComponent1::App uwpApp{nullptr};
...
void Init(HWND hwnd)
{
    ...
    source.Content(winrt::RuntimeComponent1::BlankUserControl{});

    RECT windowRect;
    ::GetWindowRect(hwnd, &windowRect);
    ::SetWindowPos(islandHWND, NULL, 0, 0, windowRect.right - windowRect.left, windowRect.bottom - windowRect.top, SWP_SHOWWINDOW);
    g_source = source;
}
                     ...
                     _In_ int       nCmdShow)
{
    ...
    OutputDebugString(std::to_wstring(winrt::RuntimeComponent1::Class{}.MyProperty()).data());
